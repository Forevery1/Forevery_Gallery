...
public class SideBar extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.github.forevery.wegallery.R.styleable.SideBar);
            float maxTranslationX = a.getDimension(com.github.forevery.wegallery.R.styleable.SideBar_maxTranslationX, 0);
